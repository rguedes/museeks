...
export default {
    ...
    stopTorrent: function(_id) {

        AppDispatcher.dispatch({
            actionType : AppConstants.APP_STOP_TORRENT,
            _id         : _id
        });
    },

    startTorrent: function(_id) {

        AppDispatcher.dispatch({
            actionType : AppConstants.APP_START_TORRENT,
            _id         : _id
        });
    },
    ...
    addTorrent(torrents) {
        ...
        dialog.showOpenDialog({ properties: ['openFile', 'multiSelections'], filters: {name:'Torrent', extensions: ['torrent']} }, (torrents) => {
            if(torrents !== undefined) {
                AppDispatcher.dispatch({
                    actionType : AppConstants.APP_ADD_TORRENT,
                    torrents    : torrents
                });
            }
        });
    ...
    removeTorrent(index) {
        AppDispatcher.dispatch({
            actionType : AppConstants.APP_DELETE_TORRENT,
            index      : index
        });
    }/*,
